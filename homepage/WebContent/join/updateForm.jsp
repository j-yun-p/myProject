	...
	<div class="container">
		...
		<form class="form-horizontal" 
			...
			<div class="form-group">
				...
				<div class="col-sm-3"><%=dto.getId() %></div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4"><%=dto.getJname() %></div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="sample6_address"
						value="<%=dto.getAddress1() %>" name="address1"> <input type="text"
						class="form-control" id="sample6_detailAddress" value="<%=dto.getAddress2() %>"
						name="address2">
				</div>
			</div>

			<div class="form-group">
				<label class="control-lable col-sm-2" for="job"> <span
