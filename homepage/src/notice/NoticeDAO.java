...
public class NoticeDAO {
	...
	public List<NoticeDTO> list(Map map){
		...
		StringBuffer sql = new StringBuffer();
		sql.append(" select no, id, title, viewcnt, to_char(wdate, 'yyyy-mm-dd') wdate, r ");
		sql.append(" from( ");
		sql.append("    select no, id, title, viewcnt, wdate, rownum r ");
		sql.append("    from( ");
		sql.append("         select no, id, title, viewcnt, wdate ");
	...
	public NoticeDTO read(int no) {
		...
		StringBuffer sql = new StringBuffer();
		sql.append(" select id, title, content, viewcnt, wdate ");
		sql.append(" from notice ");
		sql.append(" where no = ? ");
