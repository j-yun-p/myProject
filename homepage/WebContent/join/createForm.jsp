...
<body>
	...
	<div class="container">
		...
		<label class="col-sm-offset-2 col-sm-10"> (<span id="need">*</span>필수입력사항)
		</label>

		<form class="form-horizontal" action="preProc.jsp" method="post"
			...
			<div class="form-group">
				<label class="control-label col-sm-2" for="jname"><span
					id="need">*</span>이름</label>
				<div class="col-sm-4">
					<input type="text" class="form-control" id="jname"
						placeholder="Enter name" name="jname">
				</div>
			</div>
			<div class="form-group">
